  ...
  "commands": [
    {
      ...
      result: "0",
      output: "-- create_table("roles", {:force=>true}) NOTICE: CREATE TABLE will create implicit sequence "roles_id_seq" for serial column "roles.id" NOTICE: CREATE TABLE / PRIMARY KE
