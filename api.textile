...
* "listing of user's projects":#projects
* "listing of project's branches":#branches
* "status of a project's branch":#branch_status
* "history of a project's branch":#branch_history
...
h3. 1. User's projects<a name="projects">&nbsp;</a>
...
h3. 2. Project's branches<a name="branches">&nbsp;</a>
...
h3. 3. Branch Status<a name="branch_status">&nbsp;</a>
...
h3. 4. Branch History<a name="branch_history">&nbsp;</a>
...
h3. 5. Build Information<a name="build_information">&nbsp;</a>
...
h3. 6. Build Log<a name="build_log">&nbsp;</a>
