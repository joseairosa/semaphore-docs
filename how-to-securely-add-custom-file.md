...
For your new custom file you need to specify a target file path. For instance, if you have a project "semaphore" and you want to add a new custom file to your project's config directory, your file path should look like the one on the screenshot below:
